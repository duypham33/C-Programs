/*
      ...
      * Description: This program prompts the user for inputs to the 7 equations and apply functions for evaluating them based on the inputs:
...
*/
    ...
    tan_theta = calculate_tan_theta(theta); 
    ...
    total_resistance = calculate_total_resistance(R1, R2, R3);
    ...
    double y = 0.0;
    y = calculate_general_equation(b, z, x, a);
